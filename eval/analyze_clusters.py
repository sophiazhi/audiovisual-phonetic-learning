...
def confusion_matrix(eval_list, eval_posteriors, alignment_corpus, png_name):
...
if __name__ == '__main__':
    ...
    confusion_matrix(eval_list, eval_posteriors, args.alignment_corpus, f'{args.id}/{args.id}_cluster_assignments')
